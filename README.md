# This Project is Built on MEEN (MongoDB ExpressJS EJS NodeJS) that perfroms the CRUD (Create Read Update Delete) operations
...
[![My Skills](https://skillicons.dev/icons?i=taliwindcss)](https://skillicons.dev)
